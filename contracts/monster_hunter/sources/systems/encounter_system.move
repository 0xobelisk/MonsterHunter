module monster_hunter::encounter_system {
    ...
    use monster_hunter::not_in_encounter_error;
    ...
    public fun throw_ball(schema: &mut Schema, random: &Random, ctx: &mut TxContext) {
        ...
        not_in_encounter_error::require(schema.monster_info().contains(player));
        ...
        if (rand % 2 == 0) {
            ...
            let mut monsters = schema.owned_by()[player];
            monsters.push_back(monster);
            schema.owned_by().set(player, monsters);
