...
use monster_hunter::encounter_info;
use sui::address;
use monster_hunter::direction;
use monster_hunter::position;
use monster_hunter::direction::Direction;
use monster_hunter::errors::{cannot_move_error, space_obstructed_error, already_registered_error,
    in_encounter_error
};
...
fun start_encounter(schema: &mut Schema, clock: &Clock, player: address) {
    ...
    let encounter_info = encounter_info::new(monster, 0);
